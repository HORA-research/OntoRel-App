...
include::doc/antora/en-ca/modules/ROOT/partials/other/overview-component.adoc[]
...
include::doc/antora/en-ca/modules/ROOT/partials/requirements/req_software.adoc[]

include::doc/antora/en-ca/modules/ROOT/partials/requirements/req_griiscomponent.adoc[]
