...
include::doc/antora/fr-ca/modules/ROOT/partials/requirements/req_software.adoc[]

include::doc/antora/fr-ca/modules/ROOT/partials/requirements/req_griiscomponent.adoc[]
