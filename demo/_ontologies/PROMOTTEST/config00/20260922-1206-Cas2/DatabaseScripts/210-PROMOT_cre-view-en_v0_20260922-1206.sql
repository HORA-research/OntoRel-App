...
COMMENT ON SCHEMA "PROMOT_en" IS 'Create views in en of PROMOT 20260922-1206';
...
CREATE VIEW "PROMOT_en"."Ta26cfc2b00_C2" AS
  SELECT "Ta26cfc2b00_uid" AS "uid C2_en",  
    "Ta26cfc2b00_tuple_full_iri" AS "Ta26cfc2b00_tuple_full_iri_en",  
    "Ta26cfc2b00_tuple_label_en" AS "Ta26cfc2b00_tuple_label_en_en",  
    "Ta26cfc2b00_tuple_label_fr" AS "Ta26cfc2b00_tuple_label_fr_en",  
    "Ta26cfc2b00_tuple_label_es" AS "Ta26cfc2b00_tuple_label_es_en"
