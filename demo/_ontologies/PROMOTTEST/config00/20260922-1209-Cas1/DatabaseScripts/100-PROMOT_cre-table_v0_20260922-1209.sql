...
COMMENT ON SCHEMA "PROMOT" IS 'Schéma PROMOT créé le 20260922-1209';
...
COMMENT ON COLUMN "PROMOT"."Ta26cfc2b00"."Ta26cfc2b00_uid" IS 'uid C2::Default primary key of C2';
...
-- Foreign key definition : Tbb1ea32f00 -> Ta26cfc2b00
ALTER TABLE "PROMOT"."Tbb1ea32f00"
  ADD CONSTRAINT "fk0_Tbb1ea32f00" FOREIGN KEY ("Tbb1ea32f00_uid")
    REFERENCES "PROMOT"."Ta26cfc2b00" ("Ta26cfc2b00_uid");

COMMENT ON CONSTRAINT "fk0_Tbb1ea32f00" ON "PROMOT"."Tbb1ea32f00" IS 'C2.2 -> C2';
