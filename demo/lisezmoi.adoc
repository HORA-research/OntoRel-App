...
Dans le terminal, depuis le répertoire racine du projet, exécuter les commandes suivantes:

=== MONDIAL

==== Générer les graphes Cypher
----
...
_Il faut indiquer où est généré l'artéfact en spécifiant son nom et en précisant qu'il peut être
...
NOTE:: Il est important de noter que le choix de configuration peut entrainer des effets de bord sur certaines combinaisons de configuration.
